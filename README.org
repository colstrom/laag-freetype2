#+TITLE: Library as a Gem - freetype2
#+LATEX: \pagebreak

* Overview

  ~laag-freetype2~ packages [[https://www.freetype.org/][freetype2]] as a Ruby Gem, using [[https://github.com/colstrom/laag][laag]].
...
* Updating this Package
  ...
  #+BEGIN_SRC shell
    git-vendor update freetype2 VER-2-9-1
  #+END_SRC
